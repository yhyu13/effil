...
namespace effil
{
	...
	public:
		...
		BaseGCObject() = default;
		// All views are copy constructable
		BaseGCObject(const BaseGCObject&) = default;
		BaseGCObject&						 operator=(const BaseGCObject&) = default;
	...
	public:
		...
		std::unordered_set<GCHandle> refers() const override
		{
			return ctx_->refers();
		}
